...
class AuditoriaServiceImplTest {
    ...
    void obtenerTodas_conRegistros_retornaLista() {
        ...
        when(auditoriaRepository.findByIdEmpresaOrderByFechaAuditoriaDesc(1))
        ...
        assertEquals("ACTUALIZAR", resultado.get(1).getAccion());
        verify(auditoriaRepository, times(1))
                .findByIdEmpresaOrderByFechaAuditoriaDesc(1);
    }
    ...
    void obtenerTodas_sinRegistros_retornaListaVacia() {
        // Arrange
        when(auditoriaRepository.findByIdEmpresaOrderByFechaAuditoriaDesc(99))
        ...
        verify(auditoriaRepository).findByIdEmpresaOrderByFechaAuditoriaDesc(99);
    }
    ...
    void obtenerPorUsuario_conRegistros_retornaFiltrado() {
        ...
        verify(auditoriaRepository).findByIdEmpresaAndIdUsuarioOrderByFechaAuditoriaDesc(1, 10);
    }
    ...
    void obtenerPorTabla_conRegistros_retornaFiltrado() {
        ...
        verify(auditoriaRepository)
                .findByIdEmpresaAndTablaAfectadaOrderByFechaAuditoriaDesc(1, "producto");
    }
